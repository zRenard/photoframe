  ...
  return (
    <div className={`${positionClasses[validPosition]} z-50 flex space-x-2`}>
      ...
      <button
        ...
        className="config-button p-3 rounded-full display-control-button transition-all duration-200"
      ...
      <button
        ...
        className="p-3 rounded-full display-control-button transition-all duration-200"
